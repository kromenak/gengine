...
{
    TYPEINFO_VAR(RectTransform, VariableType::Vector2, mAnchorMin);
    TYPEINFO_VAR(RectTransform, VariableType::Vector2, mAnchorMax);
    TYPEINFO_VAR(RectTransform, VariableType::Vector2, mPivot);
    TYPEINFO_VAR(RectTransform, VariableType::Vector2, mAnchoredPosition);
    TYPEINFO_VAR(RectTransform, VariableType::Vector2, mSizeDelta);
}
