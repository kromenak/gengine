...
private:
    ...
    // Syncing to video seems bad - it can cause audio to delay or pitch up/down weirdly.
    // Syncing to video or external both seem to work, but syncing to audio seems to give slightly better results.
