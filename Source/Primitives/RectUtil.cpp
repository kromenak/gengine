...
Rect RectUtil::CalcLocalRect(const Rect& parentRect, const Vector2& anchorMin, const Vector2& anchorMax, const Vector2& sizeDelta, const Vector2& pivot)
{
...
Vector3 RectUtil::CalcLocalPosition(const Rect& parentRect, const Vector2& parentPivot,
                                    const Vector2& anchorMin, const Vector2& anchorMax, const Vector2& anchoredPosition, const Vector2& pivot)
{
