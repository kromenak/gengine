...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, SheepValue&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::END || tok == token::CODE || tok == token::SYMBOLS || tok == token::IF || tok == token::ELSE || tok == token::GOTO || tok == token::RETURN || tok == token::COMMA || tok == token::COLON || tok == token::SEMICOLON || tok == token::OPENPAREN || tok == token::CLOSEPAREN || tok == token::OPENBRACKET || tok == token::CLOSEBRACKET || tok == token::DOLLAR || tok == token::QUOTE || tok == token::WAIT || tok == token::YIELD || tok == token::EXPORT || tok == token::BREAKPOINT || tok == token::SITNSPIN || tok == token::INTVAR || tok == token::FLOATVAR || tok == token::STRINGVAR || tok == token::ASSIGN || tok == token::OR || tok == token::AND || tok == token::EQUAL || tok == token::NOTEQUAL || tok == token::LT || tok == token::LTE || tok == token::GT || tok == token::GTE || tok == token::PLUS || tok == token::MINUS || tok == token::MULTIPLY || tok == token::DIVIDE || tok == token::MOD || tok == token::NOT || tok == token::NEGATE);
      }
#else
      ...
      symbol_type (int tok, std::string v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YY_ASSERT (tok == token::STRING || tok == token::USERID || tok == token::SYSID);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      {
        return symbol_type (token::CODE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_SYMBOLS (location_type l)
      {
        return symbol_type (token::SYMBOLS, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::OPENBRACKET, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::CLOSEBRACKET, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_SITNSPIN (location_type l)
      {
        return symbol_type (token::SITNSPIN, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_INTVAR (location_type l)
      {
        return symbol_type (token::INTVAR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_FLOATVAR (location_type l)
      {
        return symbol_type (token::FLOATVAR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_STRINGVAR (location_type l)
      {
        return symbol_type (token::STRINGVAR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_USERID (std::string v, location_type l)
      {
        return symbol_type (token::USERID, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::SYSID, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      case 67: // expr
      case 68: // sysfunc_call
        value.move< SheepValue > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      case 67: // expr
      case 68: // sysfunc_call
        value.copy< SheepValue > (YY_MOVE (that.value));
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      case 67: // expr
      case 68: // sysfunc_call
        value.move< SheepValue > (YY_MOVE (s.value));
        break;
